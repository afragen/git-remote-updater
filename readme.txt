...
Requires [Git Updater](https://github.com/afragen/git-updater) v10.0.0 or higher and Git Updater PRO an active license running on the sites you use with Git Remote Updater.
