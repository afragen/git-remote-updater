...
class ComposerAutoloaderInit916525bb03247909b6809c3419155c61
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit916525bb03247909b6809c3419155c61::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire916525bb03247909b6809c3419155c61($fileIdentifier, $file);
        }
...
function composerRequire916525bb03247909b6809c3419155c61($fileIdentifier, $file)
{
